                ...
                child: ConstrainedBox(
                  ...
                  child: IntrinsicHeight(
                    child: NavigationRail(
                      ...
                      destinations: [
                        buildRotatedTextRailDestination('Burger', padding),
                        buildRotatedTextRailDestination("¨Pizza", padding),
                        buildRotatedTextRailDestination("Plat", padding),
                        buildRotatedTextRailDestination("Dessert", padding),
                        buildRotatedTextRailDestination("sandwitch", padding),
                        buildRotatedTextRailDestination("Drinks", padding),
                        buildRotatedTextRailDestination("Healthy", padding),
